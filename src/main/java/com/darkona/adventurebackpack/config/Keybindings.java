...
{
    private static final String KEYS_CATEGORY = "key.adventurebackpack:category";
    private static final String OPEN_INVENTORY = "key.adventurebackpack:open_inventory";
    private static final String TOGGLE_ACTIONS = "key.adventurebackpack:toggle_actions";
